...
font_add("fa-reg", here("icon/Font Awesome 6 Free-Regular-400.otf"))
font_add("fa-brands", here("icon/Font Awesome 6 Brands-Regular-400.otf"))
font_add("fa-solid", here("icon/Font Awesome 6 Free-Solid-900.otf"))
...
<span style='background-color:#333333'>Antes que nada, según un coso que cuenta el tiempo de lectura, leer todo esto te va a llevar algo más de **25 minutos**. Segundo, la versión TL;DR es ir directamente a las imágenes (son 14).</span>
...
Para todos los gráficos aquí exhibidos usé lenguaje de programación <code>R</code> (4.2.1), en el entorno de edición [RStudio](https://posit.co/products/open-source/rstudio/) (2022.12.0 Build 353). Este reporte se confeccionó usando [Quarto](https://quarto.org/) (`r quarto::quarto_version()`).
...
<span style='background-color:#333333'>Actualizado al `r format(max(HT_trad$release_date), "%d/%m/%Y")`. A fin de año voy a renovar las figuras con los datos nuevos.</span>
...
# en tamaño 64x64, .jpg (288 imágenes)
...
<span style='color:#1a1a1a'>`r now() |> ymd_hms(quiet = TRUE)`</span>
